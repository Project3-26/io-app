      ...
      <div className="lg:pl-24">
        <main className="mx-auto min-h-screen w-full max-w-5xl px-4 pb-32 pt-5 sm:px-6 lg:px-8 lg:pb-12 lg:pt-8">
          ...
          <header className="mt-8 text-center">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl border border-amber-400/20 bg-amber-400/10 text-amber-300">
              <Crown size={31} />
            </div>

            <p className="mt-5 text-xs font-bold uppercase tracking-[0.2em] text-amber-300">
              Leader Plan
            </p>
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-2">
            <section className="rounded-3xl border border-white/5 bg-gradient-to-br from-[#15222d] to-[#0d1821] p-6">
            ...
            <section className="relative overflow-hidden rounded-3xl border border-amber-400/25 bg-gradient-to-br from-amber-400/[0.12] to-[#0d1821] p-6 shadow-xl shadow-black/20">
              ...
              <div className="relative">
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-amber-200/70">Everything in Standard</p>
                    </div>
                  </div>

                  <span className="rounded-full border border-amber-400/20 bg-amber-400/10 px-3 py-1 text-[10px] font-bold uppercase tracking-wider text-amber-300">
                    Upgrade
                  </span>
                </div>
                ...
                <div className="mt-6 space-y-3">
                  {leaderFeatures.map((feature) => (
                    <p key={feature} className="flex items-start gap-2 text-sm text-slate-300">
                      <Check size={17} className="mt-0.5 shrink-0 text-amber-300" />
                      {feature}
                    </p>
                  ))}
                </div>
                ...
                <button
                  ...
                  className="mt-7 flex w-full items-center justify-center gap-2 rounded-xl bg-amber-400 px-4 py-3.5 text-sm font-bold text-[#1a1305] transition hover:bg-amber-300 active:scale-[0.98]"
                >
                  <Crown size={18} />
                  Upgrade to Leader
                </button>
