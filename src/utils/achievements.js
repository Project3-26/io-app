...
export const achievements = [
...

  {
    id: 'john-complete',
    title: 'Come and See',
    description: 'Complete the Gospel of John.',
    type: 'book',
    bookId: 'john',
    target: 1,
    tier: 'bronze',
  ...
  },
  {
    ...
    description: 'Complete Romans.',
    type: 'book',
    bookId: 'romans',
    target: 1,
    tier: 'gold',
    category: 'featured',
    artwork: 'broken-chain-cross',
    sound: 'gold',
  },
  {
    id: 'genesis-complete',
    title: 'In the Beginning',
    description: 'Complete Genesis.',
    type: 'book',
    bookId: 'genesis',
    target: 1,
    tier: 'silver',
    category: 'featured',
    artwork: 'stars-horizon',
    sound: 'silver',
  },
  {
    id: 'acts-complete',
    title: 'To the Ends of the Earth',
    description: 'Complete Acts.',
    type: 'book',
    bookId: 'acts',
    target: 1,
    tier: 'gold',
  ...
  },
  {
    id: 'mark-complete',
    title: 'Follow Me',
    description: 'Complete Mark.',
    type: 'book',
    bookId: 'mark',
    target: 1,
    tier: 'silver',
    category: 'featured',
    artwork: 'sandaled-footsteps',
    sound: 'silver',
  },
  {
    id: 'habakkuk-complete',
    title: 'Live by Faith',
    description: 'Complete Habakkuk.',
    type: 'book',
    bookId: 'habakkuk',
    target: 1,
    tier: 'bronze',
    category: 'featured',
    artwork: 'watchtower-sunrise',
    sound: 'bronze',
  },
  {
    id: 'proverbs-complete',
    title: 'Wisdom Walker',
    description: 'Complete Proverbs.',
    type: 'book',
    bookId: 'proverbs',
    target: 1,
    tier: 'silver',
  ...
  },
  {
    ...
    description: 'Complete James.',
    type: 'book',
    bookId: 'james',
    target: 1,
    tier: 'bronze',
    category: 'featured',
    artwork: 'hands-tools-heart',
    sound: 'bronze',
  },
  {
    id: 'first-samuel-complete',
    title: 'A Heart After God',
    description: 'Complete 1 Samuel.',
    type: 'book',
    bookId: 'first-samuel',
    target: 1,
    tier: 'silver',
  ...
  {
    id: 'jonah-complete',
    title: 'Mercy Runs Deep',
    description: 'Complete Jonah.',
    type: 'book',
    bookId: 'jonah',
    target: 1,
    tier: 'bronze',
  ...
  {
    id: 'ephesians-complete',
    title: 'In Christ',
    description: 'Complete Ephesians.',
    type: 'book',
    bookId: 'ephesians',
    target: 1,
    tier: 'silver',
