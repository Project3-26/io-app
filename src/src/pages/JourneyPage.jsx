        ...
        <main className="mx-auto min-h-screen w-full max-w-7xl px-3 pb-32 pt-5 min-[375px]:px-4 sm:px-6 sm:pt-6 lg:px-8 lg:pb-10 lg:pt-8 xl:px-10">
          <header className="flex items-start justify-between gap-4">
            ...
            >
              ...
              <span className="absolute -right-1 -top-1 z-20 flex h-5 min-w-5 items-center justify-center rounded-full border-2 border-[#041326] bg-orange-500 px-1 text-[10px] font-bold text-white shadow-lg shadow-orange-500/40">
                1
              </span>
            </button>
          </header>
          ...
          <section className="mt-7 grid gap-4 lg:grid-cols-12 lg:gap-6">
            <article className="rounded-3xl border border-white/5 bg-gradient-to-br from-[#0b2742] to-[#071a2d] p-5 shadow-xl shadow-black/20 lg:col-span-7 lg:p-6">
            ...
            <button
              ...
              className="group rounded-3xl border border-cyan-400/15 bg-gradient-to-br from-cyan-400/[0.08] to-[#071a2d] p-5 text-left shadow-xl shadow-black/20 transition hover:-translate-y-0.5 hover:border-cyan-400/30 active:translate-y-0 active:scale-[0.99] lg:col-span-5 lg:p-6"
            >
              <div className="flex items-center justify-between gap-3">
                <h2 className="text-base font-semibold sm:text-lg">
                  Current Book
          ...
          <section className="mt-4 rounded-3xl border border-white/5 bg-gradient-to-br from-[#0b2742] to-[#071a2d] p-5 shadow-xl shadow-black/20 lg:mt-6 lg:p-6">
            <h2 className="text-base font-semibold sm:text-lg">
              Journey at a Glance
            </h2>
          ...
          <section className="mt-7">
            ...
            <div className="mt-2 overflow-hidden rounded-3xl border border-white/5 bg-gradient-to-br from-[#0b2742] to-[#071a2d]">
          ...
          <section className="mt-6 overflow-hidden rounded-3xl border border-cyan-400/10 bg-gradient-to-br from-cyan-400/[0.08] via-[#0b2742] to-orange-400/[0.05] p-5 sm:p-6">
