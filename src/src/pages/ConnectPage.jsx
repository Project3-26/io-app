          ...
          <header>
            ...
            <div className="mt-3 flex items-start justify-between gap-4">
              ...
              >
                ...
                <span className="absolute -right-1 -top-1 flex h-5 min-w-5 items-center justify-center rounded-full border-2 border-[#041326] bg-orange-500 px-1 text-[10px] font-bold text-white">
                  6
                </span>
              </div>
            </div>
              ...
              {connectRooms.map((room) => {
                ...
                return (
                  <button
                    ...
                    className={`group relative overflow-hidden rounded-3xl border bg-gradient-to-br from-[#0b2742] to-[#071a2d] p-5 text-left shadow-xl shadow-black/20 transition active:scale-[0.99] ${styles.border} ${styles.glow} ${
                      room.locked
