      ...
      <div className="lg:pl-24">
        <main className="mx-auto min-h-screen w-full max-w-4xl px-4 pb-32 pt-5 sm:px-6 lg:px-8 lg:pb-12 lg:pt-8">
          ...
          <header className="mt-8 flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-bold tracking-[0.18em] text-cyan-400">PROJECT 3|26</p>
          ...
          <section className="mt-8 space-y-3">
            {notifications.map((notification) => {
              ...
              return (
                <article key={notification.id} className="flex items-start gap-4 rounded-2xl border border-white/5 bg-gradient-to-br from-[#0b2742] to-[#071a2d] p-4 sm:p-5">
