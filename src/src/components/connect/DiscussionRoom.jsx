    ...
    <div>
      ...
      >
        ...
        <button
          ...
          className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-cyan-400 px-4 py-3 text-sm font-bold text-[#041326] disabled:cursor-not-allowed disabled:opacity-40"
        >
          <Send size={18} />
          Share
        </button>
