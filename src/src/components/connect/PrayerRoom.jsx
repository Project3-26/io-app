...
function PrayerRoom() {
  ...
  return (
    <div>
      <section className="rounded-3xl border border-cyan-400/15 bg-gradient-to-br from-cyan-400/[0.08] to-transparent p-5 shadow-xl shadow-black/20">
        ...
        <button
          ...
          className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-cyan-400 px-4 py-3 text-sm font-bold text-[#170d20]"
        >
          {showPrayerForm ? (
            <X size={18} />
          ) : (
      ...
      {showPrayerForm && (
        ...
        >
          ...
          <label
            ...
            className="mt-4 block text-xs font-bold uppercase tracking-widest text-cyan-300"
          >
            Details
          </label>
          ...
          <div className="mt-5 flex gap-3">
            ...
            <button
              ...
              className="flex-1 rounded-xl bg-cyan-400 px-4 py-3 text-sm font-bold text-[#170d20] disabled:opacity-40"
            >
              Post Request
            </button>
          </div>
      ...
      <div className="mt-5 space-y-4">
        {visiblePrayers.map((prayer) => {
          ...
          return (
            <article
              key={prayer.id}
              className="rounded-3xl border border-cyan-400/10 bg-[#12202b] p-5"
            >
              <div className="flex items-start gap-3">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-cyan-400/10 text-xs font-bold text-cyan-200">
                  {prayer.initials}
                </div>
